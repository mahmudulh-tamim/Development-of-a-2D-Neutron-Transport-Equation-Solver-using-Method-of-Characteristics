            ...
            for p_y=num_y_rays:-1:1
                ...
                while in_dx<=mesh_center_abscissa_number && in_dy<=mesh_center_ordinate_number
                    ...
                    if y_new>dy*in_dy && abs(y_new-dy*in_dy)>10^(-5)
                        ...
                        scaler_flux(in_dy,in_dx)=scaler_flux(in_dy,in_dx)+avg_psi(in_dy,in_dx,az_count,pol_count)*weight_azimuthal(az_count,1)*w(pol_count,1);
...
for az_count=N_a/4+1:N_a/2
    ...
    for pol_count=1:polar_discretization_number
            ...
            for p_x=num_x_rays:-1:1
                i_x=ceil(ray_pos_x_bound(p_x,1));
