function scaler_flux=transport_sweep(S,exponential_portion,s_len,sum_s_len,altered_azimuthal_direction_theta,fin_d)
...
psi_in=zeros(mesh_center_ordinate_number,mesh_center_abscissa_number,azimuthal_discretization_number,polar_discretization_number,200);
psi_out=zeros(mesh_center_ordinate_number,mesh_center_abscissa_number,azimuthal_discretization_number,polar_discretization_number,200);
del_psi=zeros(mesh_center_ordinate_number,mesh_center_abscissa_number,azimuthal_discretization_number,polar_discretization_number,200);
...
for az_count=1:N_a/4
    ...
    for pol_count=1:polar_discretization_number
        ...
        for p_x=1:number_of_ray_pos_x
            ...
            ray_tracking_index_y_old=i_y;
            ray_tracking_index_x_old=i_x;
            ...
            while x_old<X && y_old<Y 
                ...
                if y>dy*ray_tracking_index_y
                    ...
                    if ray_tracking_index_y==1
                        psi_in(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))=0;
                    else
                        psi_in(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))=psi_out(ray_tracking_index_y_old,ray_tracking_index_x_old,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y_old,ray_tracking_index_x_old,az_count,pol_count));

                    end

                    del_psi(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))=(psi_in(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))-S(ray_tracking_index_y,ray_tracking_index_x)/sigma_t)*exponential_portion(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count));
                    psi_out(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))=psi_in(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))-del_psi(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count));

                    avg_psi(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count)=avg_psi(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count)+del_psi(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))/(sigma_t*sum_s_len(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))+S(ray_tracking_index_y,ray_tracking_index_x)*s_len(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))/(sigma_t*sum_s_len(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count));

                    scaler_flux(ray_tracking_index_y,ray_tracking_index_x)=scaler_flux(ray_tracking_index_y,ray_tracking_index_x)+avg_psi(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count)*weight_azimuthal(az_count,1)*w(pol_count,1);


                   
                   
                    ray_tracking_index_y_old=ray_tracking_index_y;
                    ray_tracking_index_x_old=ray_tracking_index_x;
        ...
        for p_y=1:number_of_ray_pos_y
            ...
            while x_old<X && y_old<Y 
                ...
                if y>dy*ray_tracking_index_y
                    ...
                    del_psi(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))=(psi_in(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))-S(ray_tracking_index_y,ray_tracking_index_x)/sigma_t)*exponential_portion(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count));
                    psi_out(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))=psi_in(ray_tracking_index_y_old,ray_tracking_index_x_old,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))-del_psi(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count));
        ...
        for p_y=1:number_of_ray_pos_y
            ...
            while x_old>0 && y_old<Y 
                ...
                if y>dy*ray_tracking_index_y
                    ...
                    y_new=dy*ray_tracking_index_y;
                    x_new=(y_new-y_old)/tan(altered_azimuthal_direction_theta(az_count,1))+x_old;
                     if ray_tracking_index_x==mesh_center_abscissa_number
                        psi_in(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))=0;
                    else
                        psi_in(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))=psi_out(ray_tracking_index_y_old,ray_tracking_index_x_old,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y_old,ray_tracking_index_x_old,az_count,pol_count));
            ...
            while x_old<X && y_old>0 
                ...
                if y<dy*(ray_tracking_index_y-1)
                    ...
                    x_new=(y_new-y_old)/tan(altered_azimuthal_direction_theta(az_count,1))+x_old;
                     ...
                     if ray_tracking_index_y==mesh_center_ordinate_number
                        psi_in(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))=0;
                    else
                        psi_in(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y,ray_tracking_index_x,az_count,pol_count))=psi_out(ray_tracking_index_y_old,ray_tracking_index_x_old,az_count,pol_count,ray_index_count_for_each_mesh_for_each_direction(ray_tracking_index_y_old,ray_tracking_index_x_old,az_count,pol_count));
